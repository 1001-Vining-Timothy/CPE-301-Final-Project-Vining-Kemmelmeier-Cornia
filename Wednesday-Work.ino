...
void setup()
{
  ...
  *pinD |= ~0x01 << 3; // set start to low
  ...
  //attachInterrupt(digitalPinToInterrupt(19), stop, CHANGE);
...
void STEPPER() {
  ...
  if (buttonState0 == HIGH && buttonState1 == LOW) {
    ...
    //my_delay(1000);
    Serial.print("Vent moves clockwise at: ");
    RTC_fun();
  }
  // If button 1 is pressed, rotate the stepper counterclockwise
    ...
    myStepper.step(-stepsPerRevolution/4);
    //my_delay(1000);
    Serial.print("Vent moves counter-clockwise at: ");
    RTC_fun();
  }
}
